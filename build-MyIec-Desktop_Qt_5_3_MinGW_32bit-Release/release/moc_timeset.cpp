...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TimeSet_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 40, 21)
    ...
    "TimeSet\0sendData_2\0\0TimeVar\0receiveData\0"
...
void TimeSet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->sendData_2((*reinterpret_cast< TimeVar(*)>(_a[1]))); break;
        ...
        {
            typedef void (TimeSet::*_t)(TimeVar );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TimeSet::sendData_2)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject TimeSet::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_TimeSet.data,
      qt_meta_data_TimeSet,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TimeSet.stringdata))
...
// SIGNAL 0
void TimeSet::sendData_2(TimeVar _t1)
{
