...
QT_MOC_LITERAL(7, 86, 12)
    ...
    "ComSet\0sendData\0\0SerialVar\0"
...
void ComSet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ComSet::*_t)(SerialVar );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ComSet::sendData)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ComSet::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ComSet.data,
...
// SIGNAL 0
void ComSet::sendData(SerialVar _t1)
{
