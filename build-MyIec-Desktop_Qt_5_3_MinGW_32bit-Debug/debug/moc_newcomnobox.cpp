/****************************************************************************
** Meta object code from reading C++ file 'newcomnobox.h'
**
...
#include "../../MyIec/newcomnobox.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'newcomnobox.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_NewComboBox_t, stringdata) + ofs \
...
const QMetaObject NewComboBox::staticMetaObject = {
    { &QComboBox::staticMetaObject, qt_meta_stringdata_NewComboBox.data,
      qt_meta_data_NewComboBox,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NewComboBox.stringdata))
